...
This Code of Conduct applies within all project spaces — including the GitHub repository, issue tracker, pull requests, and any other official communication channels. It also applies when an individual is officially representing the project in public spaces.
